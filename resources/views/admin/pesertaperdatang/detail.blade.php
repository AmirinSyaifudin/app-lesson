      ...
      <div class="col-md-3">
        ...
        <div class="box box-primary">
          <div class="box-body box-profile">
            ...
            <h3 class="profile-username text-center">{{ $pesertaperdatang->nama_peserta }}</h3>
            {{-- <p class="text-muted text-center">Software Engineer</p> --}}
            <ul class="list-group list-group-unbordered">
              <li class="list-group-item">
                <b>JENIS KELAMIN</b> <a class="pull-right">{{ $pesertaperdatang->jenis_kelamin }}</a>
              </li>
              <li class="list-group-item">
                <b>TINGGI BADAN</b> <a class="pull-right">{{ $pesertaperdatang->tinggi_badan }}</a>
              </li>
              <li class="list-group-item">
                <b>BERAT BADAN</b> <a class="pull-right">{{ $pesertaperdatang->berat_badan }}</a>
              </li>
              <li class="list-group-item">
                <b>NO TELPON</b> <a class="pull-right">{{ $pesertaperdatang->no_telpon }}</a>
              </li>
              <li class="list-group-item">
                <strong><i class="pull-right"></i> ALAMAT </strong>
                <a class="pull-right">{{ $pesertaperdatang->alamat }}</a>
              </li>
              <hr>
            </ul>
            <hr>
                <div class="text-center">
                    <a href="{{ route('admin.pesertaperdatang.index', $pesertaperdatang->id) }}" class="btn btn-success">Kembali</a>
                    <a href="{{ route('admin.pesertaperdatang.edit', $pesertaperdatang->id) }}" class="btn btn-warning">Edit Profile</a>
                </div>
          </div>
          <!-- /.box-body -->
        </div>
      ...
      <div class="col-md-9">
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            <li class="active"><a href="#activity" data-toggle="tab">PER DATANG-PERDATANG</a></li>
