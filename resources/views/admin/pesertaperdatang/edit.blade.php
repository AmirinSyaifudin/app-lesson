...
<div class="box">
    <div class="box-header">
        <h2 class="box-title">EDIT DATA PESERTA-PERDATANG</h2>
    </div>

        <div class="box-body">
            <form action="{{ route('admin.pesertaperdatang.update', $pesertaperdatang) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                    <div class="form-group">
                        ...
                        value="{{ $pesertaperdatang->nama_peserta ?? old('nama-peserta') }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        placeholder="Tinggi Badan" value="{{ $pesertaperdatang->tinggi_badan ?? old('tinggi_badan') }}">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">BERAT BADAN</label>
                        <input name="berat_badan" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                        placeholder="berat_badan" value="{{ $pesertaperdatang->berat_badan ?? old('berat_badan') }}">
                    </div>
